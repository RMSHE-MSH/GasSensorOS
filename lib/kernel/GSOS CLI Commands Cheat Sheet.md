...
| 命令                                       | 功能                              | 语法 示例 和 描述                                            |
| ------------------------------------------ | --------------------------------- | ------------------------------------------------------------ |
| `wifi_connect <SSID> <PASSWORD> [timeout]` | `wifi_connect`<br/>连接到指定WIFI | `wifi_connect RMSHE 114514`: 连接到名称为 RMSHE , 密码为 114514 的WIFI;<br/>`wifi_connect RMSHE 114514 10000`: 连接到名称为 RMSHE , 密码为 114514 的WIFI, WIFI 连接的超时时间为 10000ms, 超出此时间则视为连接失败; |
